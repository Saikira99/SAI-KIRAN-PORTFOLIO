...
const AnimatedBackground: React.FC = () => {
    ...
    // Memoized initial positions to prevent unnecessary recalculations
    ...
    // Function to store ref safely
    const setBlobRef = useCallback((index: number, ref: HTMLDivElement | null) => {
    ...
    useEffect(() => {
        ...
        requestId = requestAnimationFrame(handleScroll); // Start animation
